...
import boto3
import moto
import security_hub_rules
import logging
import datetime


class TestSecurityHubIam:
    @pytest.fixture
    def sh(self):
    ...
    def iam_test_user_with_policy(self, iam_test_user_id, sh):
        """
        Sets up a user with attached user policy to test iam_no_user_policy
        """
    ...
    def test_iam_no_user_policy(self, iam_test_user_id, iam_test_user_with_policy):
